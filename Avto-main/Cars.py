...
win = QWidget()
win.resize(700,700)
win.setWindowTitle('Information of sostav holodilnika')
#win.setWindowIcon()

label_caption = QLabel('Информатор про состав холодильника')
...
left = QPushButton('туди')
right = QPushButton('сюди')
